...
// node_modules/md-editor-rt/lib/md-editor-rt.es.js
...
var bus = new Bus();
var prefix = "md";
var iconfontUrl = "//at.alicdn.com/t/font_2605852_pqekijay2ij.js";
var highlightUrl = {
...
var screenfullUrl = "https://cdn.jsdelivr.net/npm/screenfull@5.1.0/dist/screenfull.js";
var allToolbar = [
  "bold",
  "underline",
  "italic",
...
var mermaidUrl = "https://cdn.jsdelivr.net/npm/mermaid@8.13.5/dist/mermaid.min.js";
var katexJsUrl = "https://cdn.jsdelivr.net/npm/katex@0.15.1/dist/katex.min.js";
var katexCssUrl = "https://cdn.jsdelivr.net/npm/katex@0.15.1/dist/katex.min.css";
...
var appendHandler = (ele) => {
  if (!document.getElementById(ele.id)) {
    document.head.appendChild(ele);
  }
};
var useKeyBoard = (props) => {
...
var Divider = () => import_react.default.createElement("div", {
  className: `${prefix}-divider`
});
var HIDDEN_CLASS = `${prefix}-dropdown-hidden`;
var DropDown = (props) => {
  const [ctl, setCtl] = (0, import_react.useState)({
    overlayClass: HIDDEN_CLASS,
    overlayStyle: {}
  });
  const status = (0, import_react.useRef)({
    triggerHover: false,
    overlayHover: false
  });
  ...
  const hiddenTimer = (0, import_react.useRef)(-1);
  const leaveHidden = (e) => {
  ...
  const trigger = (0, import_react.cloneElement)(slotDefault, {
    ref: triggerRef
  });
  const overlay = import_react.default.createElement("div", {
  ...
  return import_react.default.createElement(import_react.default.Fragment, null, trigger, overlay);
};
...
var Modal = (props) => {
  ...
  const [modalVisible, setMV] = (0, import_react.useState)(props.visible);
  const [modalClass, setModalClass] = (0, import_react.useState)([`${prefix}-modal`]);
  const modalRef = (0, import_react.useRef)(null);
  const modalHeaderRef = (0, import_react.useRef)(null);
  ...
  return import_react.default.createElement("div", {
    ...
    ref: modalHeaderRef
  }, props.title || ""), import_react.default.createElement("div", {
    className: `${prefix}-modal-func`
  }, props.showAdjust && import_react.default.createElement("div", {
...
var LinkModal = (props) => {
  var _a, _b, _c, _d, _e;
  const { usedLanguageText } = (0, import_react.useContext)(EditorContext);
  const { editorId } = (0, import_react.useContext)(EditorContext);
  ...
  const [linkData, setLinkData] = (0, import_react.useState)({
    desc: "",
    url: ""
  });
  (0, import_react.useEffect)(() => {
  ...
  return import_react.default.createElement(Modal, {
    title,
  ...
  }, (_a = usedLanguageText.linkModalTips) == null ? void 0 : _a.descLable), import_react.default.createElement("input", {
  ...
  }, (_c = usedLanguageText.linkModalTips) == null ? void 0 : _c.urlLable), import_react.default.createElement("input", {
...
var ClipModal = (props) => {
  var _a, _b;
  const editorConext = (0, import_react.useContext)(EditorContext);
  const { editorId, usedLanguageText, Cropper } = editorConext;
  const uploadRef = (0, import_react.useRef)(null);
  const uploadImgRef = (0, import_react.useRef)(null);
  const previewTargetRef = (0, import_react.useRef)(null);
  ...
  const modalSize = (0, import_react.useMemo)(() => {
  ...
  return import_react.default.createElement(Modal, __spreadValues({
  ...
  }, modalSize), import_react.default.createElement("div", {
    className: `${prefix}-form-item ${prefix}-clip`
  }, import_react.default.createElement("div", {
    className: `${prefix}-clip-main`
  }, data.imgSelected ? import_react.default.createElement("div", {
  ...
  }, (_b = usedLanguageText.linkModalTips) == null ? void 0 : _b.buttonOK)), import_react.default.createElement("input", {
    ref: uploadRef,
    accept: "image/*",
    type: "file",
    multiple: false,
...
var Modals = (props) => {
  return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(LinkModal, {
    type: props.type,
    visible: props.linkVisible,
    onOk: props.onOk,
    onCancel: props.onCancel
  }), import_react.default.createElement(ClipModal, {
...
var useSreenfull = (props) => {
  ...
  const { previewOnly } = (0, import_react.useContext)(EditorContext);
  const fullScreenHandler = (0, import_react.useCallback)(() => {
...
var TableShape = (props) => {
  ...
  }, new Array(props.tableShape[1]).fill("").map((_, rowIndex) => import_react.default.createElement("div", {
    className: `${prefix}-table-shape-row`,
    key: `table-shape-row-${rowIndex}`
  }, new Array(props.tableShape[0]).fill("").map((_2, colIndex) => import_react.default.createElement("div", {
...
var Toolbar = (props) => {
  ...
  const { editorId, usedLanguageText } = (0, import_react.useContext)(EditorContext);
  ...
  const [modalData, setModalData] = (0, import_react.useState)({
    type: "link",
    linkVisible: false,
    clipVisible: false
  });
  const toolbarLeftRef = (0, import_react.useRef)(null);
  const barRender = (barItem) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T;
    if (allToolbar.includes(barItem)) {
      switch (barItem) {
        case "-": {
          return import_react.default.createElement(Divider, {
            key: `bar-${splitNum++}`
          });
        }
        case "bold": {
        ...
        case "title": {
          return import_react.default.createElement(DropDown, {
            ...
            overlay: import_react.default.createElement("ul", {
            ...
            }, (_e = ult.titleItem) == null ? void 0 : _e.h1), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("h2");
              }
            }, (_f = ult.titleItem) == null ? void 0 : _f.h2), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("h3");
              }
            }, (_g = ult.titleItem) == null ? void 0 : _g.h3), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("h4");
              }
            }, (_h = ult.titleItem) == null ? void 0 : _h.h4), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("h5");
              }
            }, (_i = ult.titleItem) == null ? void 0 : _i.h5), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("h6");
              }
        ...
        case "image": {
          return import_react.default.createElement(DropDown, {
            ...
            }, (_t = ult.imgTitleItem) == null ? void 0 : _t.link), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                uploadRef.current.click();
              }
            }, (_u = ult.imgTitleItem) == null ? void 0 : _u.upload), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
        ...
        case "table": {
          return import_react.default.createElement(DropDown, {
            ...
            key: "bar-table",
            overlay: import_react.default.createElement(TableShape, {
        ...
        case "prettier": {
          return props.prettier ? import_react.default.createElement("div", {
            className: `${prefix}-toolbar-item`,
        ...
        case "pageFullscreen": {
          return !setting.fullscreen && import_react.default.createElement("div", {
            className: `${prefix}-toolbar-item`,
        ...
        case "mermaid": {
          return import_react.default.createElement(DropDown, {
            ...
            }, (_I = ult.mermaid) == null ? void 0 : _I.flow), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("sequence");
              }
            }, (_J = ult.mermaid) == null ? void 0 : _J.sequence), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("gantt");
              }
            }, (_K = ult.mermaid) == null ? void 0 : _K.gantt), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("class");
              }
            }, (_L = ult.mermaid) == null ? void 0 : _L.class), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("state");
              }
            }, (_M = ult.mermaid) == null ? void 0 : _M.state), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("pie");
              }
            }, (_N = ult.mermaid) == null ? void 0 : _N.pie), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("relationship");
              }
            }, (_O = ult.mermaid) == null ? void 0 : _O.relationship), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
                emitHandler("journey");
              }
        ...
        case "katex": {
          return import_react.default.createElement(DropDown, {
            ...
            }, (_R = ult.katex) == null ? void 0 : _R.inline), import_react.default.createElement("li", {
              className: `${prefix}-menu-item`,
              onClick: () => {
  ...
  const splitedbar = (0, import_react.useMemo)(() => {
  ...
  return import_react.default.createElement("div", {
    ...
    ref: toolbarLeftRef
  }, splitedbar[0].map((barItem) => barRender(barItem))), import_react.default.createElement("div", {
    className: `${prefix}-toolbar-right`
  }, splitedbar[1].map((barItem) => barRender(barItem)))), import_react.default.createElement("input", {
    ref: uploadRef,
    accept: "image/*",
    type: "file",
    multiple: true,
    style: { display: "none" }
  }), import_react.default.createElement(Modals, {
...
var saveHistoryId = -1;
var useHistory = (props, textAreaRef) => {
  const { onChange } = props;
  const { historyLength, editorId } = (0, import_react.useContext)(EditorContext);
...
var useAutoGenrator = (props, textAreaRef) => {
  ...
  const { previewOnly, tabWidth, editorId } = (0, import_react.useContext)(EditorContext);
  (0, import_react.useEffect)(() => {
    var _a, _b;
    if (!previewOnly) {
...
var useMermaid = (props) => {
  const { theme } = (0, import_react.useContext)(EditorContext);
  const [reRender, setReRender] = (0, import_react.useState)(false);
  const [mermaidInited, setMermaidInited] = (0, import_react.useState)(!!props.mermaid);
  (0, import_react.useEffect)(() => {
    if (!props.noMermaid) {
      if (props.mermaid) {
...
var useKatex = (props, marked2) => {
  const [katexInited, setKatexInited] = (0, import_react.useState)(false);
  if (!props.noKatex) {
    marked2.use({
      extensions: [
...
var useAutoScroll = (props, html, textAreaRef, previewRef, htmlRef) => {
  const { previewOnly } = (0, import_react.useContext)(EditorContext);
  const [scrollCb, setScrollCb] = (0, import_react.useState)({
    clear() {
    },
    init() {
    }
...
var usePasteUpload = (textAreaRef) => {
  const { editorId, previewOnly } = (0, import_react.useContext)(EditorContext);
...
var Content = (props) => {
  ...
  const { editorId, previewOnly, usedLanguageText, previewTheme, showCodeRowNumber } = (0, import_react.useContext)(EditorContext);
  const [highlightInited, setHighlightInited] = (0, import_react.useState)(!!hljs);
  const textAreaRef = (0, import_react.useRef)(null);
  const selectedText = (0, import_react.useRef)("");
  const previewRef = (0, import_react.useRef)(null);
  const htmlRef = (0, import_react.useRef)(null);
  const heads = (0, import_react.useRef)([]);
  ...
  }, !previewOnly && import_react.default.createElement("div", {
  ...
  })), props.setting.preview && import_react.default.createElement("div", {
  ...
  })), props.setting.htmlPreview && import_react.default.createElement("div", {
    className: `${prefix}-preview-wrapper`,
    ref: htmlRef,
...
var CatalogLink = (props) => {
  ...
  }, import_react.default.createElement("span", null, props.tocItem.text), props.tocItem.children && props.tocItem.children.map((item) => import_react.default.createElement(CatalogLink, {
...
var Catalog = (props) => {
  ...
  const catalogs = (0, import_react.useMemo)(() => {
    const tocItems = [];
  ...
  return show ? import_react.default.createElement("div", {
    className: `${prefix}-catalog`
  }, catalogs.map((item) => {
    return import_react.default.createElement(CatalogLink, {
      markedHeadingId: props.markedHeadingId,
      tocItem: item,
      key: item.text
    });
...
var Editor = (props) => {
  ...
  useKeyBoard(props);
  useExpansion(props);
  const [setting, setSetting] = (0, import_react.useState)({
    pageFullScreen,
    fullscreen: false,
    preview,
  ...
  const highlightSet = (0, import_react.useMemo)(() => {
  ...
  const usedLanguageText = (0, import_react.useMemo)(() => {
  ...
  const catalogShow = (0, import_react.useMemo)(() => {
  ...
  return import_react.default.createElement(EditorContext.Provider, {
    ...
    style: props.style
  }, !previewOnly && import_react.default.createElement(Toolbar, {
  ...
  }), import_react.default.createElement(Content, {
    hljs: props.hljs,
    highlightSet,
    ...
    extensions: props.extensions
  }), catalogShow && import_react.default.createElement(Catalog, {
    markedHeadingId: props.markedHeadingId
  })));
};
Editor.defaultProps = {
...
// dep:md-editor-rt
var md_editor_rt_default = Editor;
export {
  EditorContext,
  md_editor_rt_default as default
};
/*!
...
*/
//# sourceMappingURL=md-editor-rt.js.map
